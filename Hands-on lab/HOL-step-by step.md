...
i. In the Azure portal, click **Create a resource > Internet of Things > Stream Analytics job**.

ii. Name the job **asa_nyctaxi**, specify a subscription, resource group, and location.
